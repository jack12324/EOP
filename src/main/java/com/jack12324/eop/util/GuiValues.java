...
public enum GuiValues {
    ...
    EQUALIZINGSMELTER(175, 183, new int[]{44, 34, 180, 88, 25, 16, 107, 34, 180, 33, 25, 16, 44, 58, 180, 52, 25, 16, 107, 58, 180, 70, 25, 16}, null, null, null, null, new int[]{82, 24, 180, 20, 12, 11}),
