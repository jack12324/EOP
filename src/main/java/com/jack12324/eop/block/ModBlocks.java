...
public class ModBlocks {
	...
	public static void init() {
		...
		//ore with dust drops
		oreFirestone = register(new BlockDustOre(Material.ROCK,"ore_firestone","pickaxe",2,ModItems.dustFirestone,4,5,3.0f, 15f, SoundType.STONE));
		oreRedsoul = register(new BlockDustOre(Material.SAND,"ore_redsoul","shovel",0,ModItems.dustRedsoul,4,5,0.5f, 2.5f, SoundType.SAND));
