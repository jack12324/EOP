...
public class GuiDualCatalystInfuser extends GuiContainer {
	private TileEntityDualCatalystInfuser tileEntity;
	private InventoryPlayer playerInv;
	private static final ResourceLocation BG_TEXTURE = new ResourceLocation(ExtremeOreProcessing.modID, "textures/gui/dual_catalyst_infuser.png");
	private FluidBar fb;
	private FluidBar fb2;

	public GuiDualCatalystInfuser(Container inventorySlotsIn, InventoryPlayer playerInv, TileEntityDualCatalystInfuser tileEntity) {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		String name = I18n.format(ModBlocks.dualCatalystInfuser.getUnlocalizedName() + ".name");
