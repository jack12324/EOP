...
public class DualCatalystInfuserRecipes extends EOPRecipes {
	// the list of activation results
	public static DualCatalystInfuserRecipes INSTANCE = new DualCatalystInfuserRecipes();
	private final Map<ItemStack[], ItemStack> activationList = Maps.<ItemStack[], ItemStack>newHashMap();

	public DualCatalystInfuserRecipes() {
		this.addActivation(new Item[] { Items.NETHER_STAR, Items.QUARTZ }, ItemStack.EMPTY, new int[] { 1, 10 });
