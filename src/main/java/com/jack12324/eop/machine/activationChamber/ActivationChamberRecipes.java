...
public class ActivationChamberRecipes extends EOPRecipes {
	public static ActivationChamberRecipes INSTANCE = new ActivationChamberRecipes();
	// the list of activation results
	private final Map<ItemStack[], ItemStack> activationList = Maps.<ItemStack[], ItemStack>newHashMap();

	public ActivationChamberRecipes() {
