...
public class GuiStarHardener extends GuiContainer {
	private TileEntityStarHardener tileEntity;
	private InventoryPlayer playerInv;
	private static final ResourceLocation BG_TEXTURE = new ResourceLocation(ExtremeOreProcessing.modID, "textures/gui/star_hardener.png");
	private FluidBar fb;
	...
	final int COOK_BAR_XPOS = 64;
	final int COOK_BAR_YPOS = 25;
	final int COOK_BAR_ICON_U = 4; // texture position of white arrow icon
	final int COOK_BAR_ICON_V = 171;
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		String name = I18n.format(ModBlocks.starHardener.getUnlocalizedName() + ".name");
