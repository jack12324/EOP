...
public class ParticleExciterRecipes extends EOPRecipes{
	//the list of activation results
	public static ParticleExciterRecipes INSTANCE = new ParticleExciterRecipes();
		private final Map<ItemStack[], ItemStack> activationList = Maps.<ItemStack[], ItemStack>newHashMap();
	 
	    
	    public ParticleExciterRecipes()
	    {
