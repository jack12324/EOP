...
public class GuiParticleExciter extends GuiContainer {
	private TileEntityParticleExciter tileEntity;
	private InventoryPlayer playerInv;
	private static final ResourceLocation BG_TEXTURE = new ResourceLocation(ExtremeOreProcessing.modID, "textures/gui/particle_exciter.png");
	private FluidBar fb;

	public GuiParticleExciter(Container inventorySlotsIn, InventoryPlayer playerInv, TileEntityParticleExciter tileEntity) {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		String name = I18n.format(ModBlocks.particleExciter.getUnlocalizedName() + ".name");
