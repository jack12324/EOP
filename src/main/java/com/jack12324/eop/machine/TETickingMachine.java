...
public abstract class TETickingMachine extends TileEntity implements ITickable{
    ...
    public final void sendUpdate(){
        if(this.world != null && !this.world.isRemote){
            ...
            PacketHandler.NETWORK.sendToAllAround(new PacketServerToClient(data, PacketHandler.TILE_ENTITY_HANDLER), new NetworkRegistry.TargetPoint(this.world.provider.getDimension(), this.getPos().getX(), this.getPos().getY(), this.getPos().getZ(), 64));
        }
    }
