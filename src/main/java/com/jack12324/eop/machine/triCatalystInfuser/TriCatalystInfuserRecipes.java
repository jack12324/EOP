...
public class TriCatalystInfuserRecipes extends EOPRecipes{
	//the list of activation results
	public static TriCatalystInfuserRecipes INSTANCE = new TriCatalystInfuserRecipes();
		private final Map<ItemStack[], ItemStack> activationList = Maps.<ItemStack[], ItemStack>newHashMap();
	 
	    
	    public TriCatalystInfuserRecipes()
	    {
	    	this.addActivation(new Item[]{Items.CHORUS_FRUIT_POPPED,Items.ENDER_EYE,Items.SHULKER_SHELL}, ItemStack.EMPTY, new int[]{3,2,1});
