...
public final class InitFluids{
    ...
    public static void init(){
        fluidScreamingLava = registerFluid("screaminglava", "block_screaming_lava").setLuminosity(10).setViscosity(1000);
        ...
        fluidDragonSoul = registerFluid("dragonsoul", "block_dragon_soul").setGaseous(true).setDensity(-1).setViscosity(500);
